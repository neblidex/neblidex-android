...
namespace NebliDex_Mobile.Droid
{
    public partial class MainService : Android.App.Service
    {
        ...
        public static void FindElectrumServers()
        {
            ...
            if (File.Exists(App_Path + "/electrum_peers.dat") == false)
            {
                ...
                try
                {
                    using (System.IO.StreamWriter file =
                        new System.IO.StreamWriter(@App_Path + "/electrum_peers.dat", false))
                    {
                        int index = 0;
                        int index2 = 0;
            ...
            if (File.Exists(App_Path + "/cn_list.dat") == false)
            {
                ...
                if (DNS_SEED_TYPE == 0)
                {
                    ...
                    if (resp.Length == 0)
                    {
                        ...
                        if (dialog == true)
                        {
                            MessageBox("Notice", "Unable to connect to DNS Seed", "OK", false);
                        }
                        return;
                    }
                    try
                ...
                else
                {
                    ...
                    catch (Exception e)
                    {
                        ...
                        {
                            MessageBox("Notice", "No Critical Nodes Found!", "OK", false);
                        }
                ...
                lock (CN_Nodes_By_IP)
                {
                    ...
                    {
                        using (System.IO.StreamWriter file =
                            new System.IO.StreamWriter(@App_Path + "/cn_list.dat", false))
                        {
        ...
        public static bool AccurateCNOnlineCount()
        {
            ...
            if (total_points == 0)
            {
                ...
                else
                {
                    lock (CN_Nodes_By_IP)
                    {
                        File.Delete(@App_Path + "/cn_list.dat");
                    }
                }
        ...
        public static bool ConnectElectrumServers(int type)
        {
            if (File.Exists(App_Path + "/electrum_peers.dat") == false)
            {
            ...
            for (int i = min; i < max; i++)
            {
                ...
                try
                {
                    ...
                    if (ConnectSync(client, address, port, 5))
                    {
                        ...
                        try
                        {
                            NebliDexNetLog("Trying to create secure connection.");
                        ...
                        NebliDexNetLog("Secure connection created");
        ...
        public static bool ConnectCNServer(bool dialog)
        {
                            ...
                            if (ConnectSync(client, address, critical_node_port, 5))
                            {
                                ...
                                if (dex.blockdata.Equals("Version OK") == false)
                                {
                                    if (CN_Node_List_Clone.Count == 1)
                                    {
                                        ...
                                        {
                                            MessageBox("Notice", dex_mes, "OK", false);
                                        }
                                        ...
                                        if (dex.blockdata.Equals("This Critical Node is pending") == true)
                                        {
                                            ...
                                            return false; //The last CN is pending, leave the function for now
                                        }
                                    }
                                    else
                                    {
                                        ...
                                        do
                                        {
                                            ...
                                            if (r_method.Equals("cn.getlist"))
                                            {
                                                ...
                                                foreach (JToken row in js["cn.result"])
                                                {
                                                    ...
                                                    if (row["cn.totalmarkets"] != null)
                                                    { // TODO: Transitional condition
                        ...
                        catch (Exception e)
                        {
                            ...
                            if (program_loaded == true)
                            {
                                ...
                                if (utxo == null)
                                {
                                    ...
                                    if (dialog == true)
                                    {
                                        MessageBox("Notice", "No internet connection has been detected", "OK", false);
                                    }
                                    return false;
                                }
                            }
            ...
            if (CN_Node_List_Clone.Count == 0)
            {
                ...
                if (dialog == true)
                {
                    MessageBox("Notice", "All critical nodes are down", "OK", false);
                }
                return false;
            }
            return true;
                ...
                try
                {
                    ...
                    else if (method == "cn.pendorder")
                    {
                        if (response == 0 && con.outgoing == true)
                        {
                            ...
                            PendOrder(js["cn.result"].ToString());
                        }
                    }
                    else if (method == "cn.relayshoworder")
                    {
                        if (response == 0)
                        {
                            ...
                            if (con.outgoing == true)
                            {
                                ...
                                ShowOrder(js["cn.result"].ToString());
                            }
                            else
                            {
                                //Excluded CN methods
                    ...
                    {
                        if (response == 0 && con.outgoing == true && program_loaded == true)
                        {
                            ...
                            if (js["cn.who_validate"] == null)
                            {
                                ...
                                if (program_loaded == false) { return; }
                                ...
                                ShowTradeMessage(js["cn.result"].ToString()); //Pop up messsage box
                            }
                            else
                            {
                                //Accepted message
                            ...
                            { //Client receives from CN for inclusion
                              //We received this from a CN (more trusted), evaluate the relayed order message
                                if (critical_node == false)
                                {
                                    ...
                                    App.AddRecentTradeToView(market, type, trade_price, trade_amount, order_nonce, trade_time);
                                }
                            }
                        }
                    }
        ...
        public static void NebliDexNetLog(string msg)
        {
            ...
            lock (debugfileLock)
            {
                try
                {
                    using (StreamWriter file = File.AppendText(App_Path + "/debug.log"))
                    {
            ...
            { //Wait till this list is available
                try
                {
                    using (System.IO.StreamReader file_in =
                        new System.IO.StreamReader(@App_Path + "/electrum_peers.dat", false))
                    {
                        using (System.IO.StreamWriter file_out =
                            new System.IO.StreamWriter(@App_Path + "/electrum_peers_new.dat", false))
                        {
                            int index = type;
                            ...
                            while (file_in.EndOfStream == false)
                            {
                                ...
                                if (server_count == 0)
                                {
                                    ...
                                    file_out.Close();
                                    file_in.Close();
                                    File.Delete(App_Path + "/electrum_peers_new.dat");
                    ...
                    if (File.Exists(App_Path + "/electrum_peers_new.dat") != false)
                    {
                        File.Delete(App_Path + "/electrum_peers.dat");
                        File.Move(App_Path + "/electrum_peers_new.dat", App_Path + "/electrum_peers.dat");
                    }
                }
                catch (Exception)
                {
        ...
        public static void RecreateCNList()
        {
            ...
            { //Make this code thread safe
                ...
                {
                    using (System.IO.StreamWriter file_out =
                        new System.IO.StreamWriter(@App_Path + "/cn_list_new.dat", false))
                    {
                    ...
                    //Move the files around so we don't store anything in memory
                    if (File.Exists(App_Path + "/cn_list_new.dat") != false)
                    {
                        if (File.Exists(App_Path + "/cn_list.dat") == true)
                        {
                            File.Delete(App_Path + "/cn_list.dat");
                        }
                        File.Move(App_Path + "/cn_list_new.dat", App_Path + "/cn_list.dat");
                    }
                }
                catch (Exception)
                {
            ...
            lock (CN_Nodes_By_IP)
            {
                try
                {
                    using (System.IO.StreamReader file =
                        new System.IO.StreamReader(@App_Path + "/cn_list.dat", false))
                    {
                ...
                catch (Exception e)
                {
                    ...
                    File.Delete(@App_Path + "/cn_list.dat"); //Delete then try to reload again
                }
            }
        }
        ...
        public static bool SelectRandomElectrum(int type, string[] prop)
        {
            ...
            File.Delete(App_Path + "/electrum_peers.dat"); //Unable to find a server to connect to, re-download whole list
            return false;
        }

        //Query Servers periodically
        //For Android, this is ran every 30 seconds to save battery instead of every 5 seconds
        ...
        public static void PeriodicNetworkQuery(object state)
        {
            ...
            try
            {
                //We may need to acquire a wakelock
                int c_time = UTCTime();
                if(LastNetworkQueryTime < 0)
                {
                    LastNetworkQueryTime = c_time;
                }else
                {
                    //Check if pending payments and if open orders present
                    if(CheckPendingPayment() == true || MyOpenOrderList.Count > 0)
                    {
                        PeriodicTimer_WakeLock.Acquire(60 * 1000); //Acquire a 60 second wakelock
                    }

                    if(c_time - LastNetworkQueryTime > 45)
                    {
                        //The CPU was sleeping, set and go to settings page
                        if(current_ui_page != 4)
                        {
                            current_ui_page = 4;
                            if (NebliDex_UI != null)
                            {
                        ...
                        App.force_reload_marketdata = true; //Market data will be out of sync
                        LastNetworkQueryTime = c_time;
                        return; //Skip the rest of the function if cpu is not running evenly
                    }
                ...
                lock (DexConnectionList)
                {
                    for (int i = DexConnectionList.Count - 1; i >= 0; i--)
                    {
                        ...
                        if (mydex.open == false)
                        {
                            ...
                            if (mydex.outgoing == true && mydex.contype == 3)
                            {
                ...
                lock (DexConnectionReqList)
                {
                    for (int i = DexConnectionReqList.Count - 1; i >= 0; i--)
                    {
                        ...
                        else
                        {
                            ...
                            if (UTCTime() - DexConnectionReqList[i].creation_time > 45)
                            {
                    ...
                    for (int i = 0; i < DexConnectionList.Count; i++)
                    {
                        ...
                        try
                        {
                            if (mydex.contype == 1)
                            {
                                ...
                                { //Send keep alive every 50 seconds (Electrum drops connection after 10 minutes)
                ...
                //Update the block rates display
                if (NebliDex_UI != null)
                {
                    NebliDex_Activity.RunOnUiThread(() => {
                        NebliDex_UI.UpdateBlockrates();
                    });                   
                }
        ...
        public static void PeriodicLongRunners()
        {
            ...
            try
            {
                //This function contains methods that can run longer than 30 seconds
                //It will at least be ran every 30 seconds
                ...
                //Now check transactions every 30 seconds for changes on blockchain
                try
                {
        ...
        public static void CheckElectrumServerSync()
        {
            ...
            for (int etype = 1; etype < total_cointypes; etype++)
            {
                ...
                try
                {
                    ...
                    //Now we will query 2 electrum servers of same type for their blockheights
                    //And if ours is lower than theirs, we disconnect ours

                    bool only_server = true;

                    for (int i = 0; i < 2; i++) //NebliDex Android only checks half the amount of servers compared to normal NebliDex
                    {
                        //Connect to electrum servers
                        string[] electrum_info = new string[2];
                        ...
                        try
                        {
                            ...
                            if (ConnectSync(client, address, port, 5))
                            {
                                ...
                                try
                                {
                                    NebliDexNetLog("Trying to obtain a secure connection");
                                    secure_nStream.AuthenticateAsClient(electrum_info[0]);
                                }
                                catch (Exception e)
                                {
                                ...
                                NebliDexNetLog("Obtained a secure connection");
                    ...
                    if (only_server == true)
                    {
                        ...
                        if (testnet_mode == false)
                        {
                            File.Delete(App_Path + "/electrum_peers.dat"); //Remove this to force a relook on mainnet
                            FindElectrumServers();
                        }
                    }
